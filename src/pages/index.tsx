  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Empowering Employees and Payroll Teams with a Unified Platform for Comprehensive Employee Data and Payroll Information Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Empowering Employees and Payroll Teams with a Unified Platform for Comprehensive Employee Data and Payroll Information Management.`}
            </Text>
            <Box
